...
// //     return Scaffold(
// //       body: viewModel.staffCartFoodList.isEmpty?Expanded(
// //         child: Padding(
...
//     final viewModel =
//         mViewModel ?? Provider.of<StaffSelectProductViewModel>(context);
//     final bool isCartEmpty = viewModel.staffCartFoodList.isEmpty;
//     return Scaffold(
//       body: Row(
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
...
//                           height: 40,
//                           onPressed: () async {
//                             if (viewModel.isApiLoading == true) return;
//                             print('Placing order...');
//                             final orderId = await viewModel.placeOrderApi(
...
//                               showRedToastMessage('Failed to get order ID');
//                               return;
//                             }
//
//                             if (!mounted) {
...
//                             }
//
//                             print('Fetching bill details for order: $orderId');
//                             await viewModel.getTableBill(
//                               orderNo: orderId,
//                               orderType: widget.tableNo == "Take away order" ? "Take away order" : "",
//                               tableNo: widget.tableNo == "Take away order" ? "0" : widget.tableNo,
//                             );
//
//                             if (!mounted) {
//                               print('Widget not mounted after bill fetch');
//                               return;
//                             }
//
//                             print('Navigating to GetBillView with orderId: $orderId');
//                             pushToScreen(GetBillView(
//                               tableNo: widget.tableNo,
//                               orderNo: orderId,
//                             ));
...
//                                   if (!mounted) {
//                                     print(
//                                         'Widget not mounted, aborting navigation');
//                                     return;
//                                   }
//                                   print(
//                                       'Fetching bill details for order: $orderId');
//                                   await viewModel.getTableBill(
//                                     orderNo: orderId,
//                                     orderType:
//                                         widget.tableNo == "Take away order"
...
//                                   if (!mounted) {
//                                     print(
//                                         'Widget not mounted after bill fetch');
//                                     return;
//                                   }
//                                   print(
//                                       'Navigating to GetBillView with orderId: $orderId');
//                                   pushToScreen(GetBillView(
//                                     tableNo: widget.tableNo,
//                                     orderNo: orderId,
//                                   ));
...
//                                                 : widget.tableNo,
//                                           );
//                                           // Optionally update other UI or navigate
//                                         }
//                                       },
//                                       text: 'Save',
//                                     ),
                        ...
                        child: viewModel.staffCartFoodList.isEmpty
                            ? Column(
                                ...
                                children: [
                                  ...
                                  if (widget.tableNo != "Take away order")
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: GestureDetector(
                                        onTap: () {
